...
public class Block04_1Test {
    ...
    public void test() {
        ...
        Assert.assertEquals(1, block.publicKeyStoreIndex);
        Assert.assertEquals(4, block.publicKeyIndex);
        Assert.assertEquals("20500101", block.expiryDate);
        Assert.assertEquals(1, block.hashAlgorithmIndicator);
        Assert.assertEquals(1, block.publicKeyAlgorithmIndicator);
