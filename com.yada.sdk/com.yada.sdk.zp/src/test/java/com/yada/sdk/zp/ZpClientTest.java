...
public class ZpClientTest {
	...
	@Test
	public void testGetField48Usage4Tag92() {
		String cvn2 = "123";
		String field48 = ZpClient.getField48Usage4Tag92(cvn2);
		Assert.assertEquals(field48.length(), 9);
	}
	...
	public void testGetField61() {
		...
		credentialsNo = "";
		mobileNo = "";
		field61 = ZpClient.getField61(hasPassword, hasValidityPeriod,
				hasCVN2, credentialsType, credentialsNo, mobileNo);
